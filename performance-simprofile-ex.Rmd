...
bench::mark(
  {test <- simulate(reps = 100, seed = 20141028, data = testdata)},
  {test <- simulate_fast(reps = 100, seed = 20141028, data = testdata)},
  relative = TRUE
)[,1:5]
```
...
- estimate coefficients dauert sehr lang, hierbei besonders die funktion lm
- model.matrix.default bei simulate_response dauert auch lang.
